...
public class Ders_OgrenciRepo {
    ...
    public ArrayList<Ders_Ogrenci> getAll()
    {
        ...
        try
        {
            ...
            while (result.next())
            {
                Ders_Ogrenci temp = new Ders_Ogrenci(result.getInt("ID"), result.getInt("DERS_ID"), result.getInt("OGRENCI_ID"));
                liste.add(temp);
            }
        }
        catch (Exception e)
    ...
    public Ders_Ogrenci getById(int id)
    {
        ...
        try
        {
            ...
            while (result.next())
            {
                dersOgrenci = new Ders_Ogrenci(result.getInt("ID"), result.getInt("DERS_ID"), result.getInt("OGRENCI_ID"));
            }
        }
        catch (Exception e)
        {
